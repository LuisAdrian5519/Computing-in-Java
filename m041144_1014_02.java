...
//Ahora bien, el bono por concepto de sueldo, si éste es menor a $1000, se da 25 % de éste, cuando éste es mayor a $1000, pero menor o igual a $3500, se otorga 15% de su sueldo, para más de $3500. 10%. Realice el algoritmo correspondiente para calcular los dos tipos de bono, asignando el mayor, y represéntelo con un diagrama de flujo y pseudocódigo.
	...
	System.out.print("¿De Cuánto es tu sueldo?");
	Sueldo = Teclado.nextInt();

	if (Antiguedad >= 2 & Antiguedad <= 5 & Sueldo < 1000)
		{
		System.out.println("Tu bono por antiguedad es de:" + Sueldo*0.20);
		System.out.println("Tu bono por sueldo es de:" + Sueldo*0.25);
		System.out.println("Tu salario final es:" + (Sueldo + Sueldo*0.20 + Sueldo*0.25));
		}

    else if (Antiguedad < 2 & Sueldo < 1000)
		{
        System.out.println("Tu bono por antiguedad es de:" + 0);
        System.out.println("Tu bono por sueldo es de:" + Sueldo*0.25);
		System.out.println("Tu salario final es:" + (Sueldo + Sueldo*0.25));
		}

	else if (Antiguedad > 5 & Sueldo < 1000)
		{
		System.out.println("Tu bono por antiguedad es de:" + Sueldo*0.30);
		System.out.println("Tu bono por sueldo es de:" + Sueldo*0.25);
		System.out.println("Tu salario final es:" + (Sueldo + Sueldo*0.30 + Sueldo*0.25));
		}

	if (Antiguedad >= 2 & Antiguedad <= 5 & Sueldo >= 1000 & Sueldo <= 3500 )
		{
		System.out.println("Tu bono por antiguedad es de:" + Sueldo*0.20);
		System.out.println("Tu bono por sueldo es de:" + Sueldo*0.15);
		System.out.println("Tu salario final es:" + (Sueldo + Sueldo*0.20 + Sueldo*0.15));
		}
        ...
        System.out.println("Tu bono por antiguedad es de:" + 0);
        System.out.println("Tu bono por sueldo es de:" + Sueldo*0.15);
		System.out.println("Tu salario final es:" + (Sueldo + Sueldo*0.15));
		}
		...
		System.out.println("Tu bono por antiguedad es de:" + Sueldo*0.30);
		System.out.println("Tu bono por sueldo es de:" + Sueldo*0.15);
		System.out.println("Tu salario final es:" + (Sueldo + Sueldo*0.30 + Sueldo*0.15));
		}

	if (Antiguedad >= 2 & Antiguedad <= 5 & Sueldo > 3500)
		{
		System.out.println("Tu bono por antiguedad es de:" + Sueldo*0.20);
		System.out.println("Tu bono por sueldo es de:" + Sueldo*0.10);
		System.out.println("Tu salario final es:" + (Sueldo + Sueldo*0.20 + Sueldo*0.10));
		}
	    ...
	    System.out.println("Tu bono por antiguedad es de:" + 0);
	    System.out.println("Tu bono por sueldo es de:" + Sueldo*0.10);
		System.out.println("Tu salario final es:" + (Sueldo + Sueldo*0.10));
		}
